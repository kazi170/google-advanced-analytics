...
# ==> ENTER YOUR RESPONSE HERE
# no there is not a big difference between them. The sd and mean is pretty close. 
...
d_null['device'].value_counts()


# 
# 447 iphone users with null values and 253 Android users with null values. 
...
### YOUR CODE HERE ###
percent_phone_null= d_null['device'].value_counts(normalize=True)

print(percent_iphone_null)
...
### YOUR CODE HERE ###
percent_phone_n_null= df['device'].value_counts(normalize=True)
print(percent_phone_n_null)
...
percent_count_label= df['label'].value_counts(normalize='True')
print(percent_count_label)
...
### YOUR CODE HERE ###
median_drive= df.groupby('label').median(numeric_only=True)
# Divide the median distance by median number of drives
### YOUR CODE HERE ###
median_km_perdrive= median_drive['driven_km_drives']/median_drive['drives']
print(median_km_perdrive)
...
### YOUR CODE HERE ###
median_no_kmperday= median_drive['driven_km_drives']/median_drive['driving_days']
print(median_no_drivedays)
...
### YOUR CODE HERE ###
median_drive_per_day= median_drive['drives']/median_drive['driving_days']
print(median_drive_per_day)
...
# ==> 1) The data containted 700 missing values under the label column. no patterns found.  
# 2) A mean value might be skewed by a outliers and not represent an accurate picture of the majority of the population. 
# 3)Yes, I would like to know how the data was collected, it seems like the users who churn are long distance drivers. Users who churn drive over 250%  per drive day. 
# 4)64.9% are iphone users and 35.1% are android users. 
# 5)users who churned travel longer distances in shorter period of time.
# 6) No they are pretty consistent. 
